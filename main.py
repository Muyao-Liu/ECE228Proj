...
parser.add_argument('--lr_D', type=float, default=0.00102,
...
parser.add_argument('--cont_lambda', type=float, default=1.5, help='cont_lambda')
...
def train():
    ...
    for epoch in range(opt.num_epoch):
        ...
        D_losses = []
        Cont_losses = []
        for i, img in enumerate(zip(src_loader, cartoon_loader, cartoon_loader)):
